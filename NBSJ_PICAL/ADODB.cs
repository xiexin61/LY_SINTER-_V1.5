...
namespace NBSJ_PICAL
{
    ...
    {
        #region  全局变量
          public string ConnectionString = "Server=10.5.130.28;Database=LGSJ;Trusted_Connection=yes;uid=sa;password=Yjs88291280;MultipleActiveResultSets=true;Integrated Security=True;Connect Timeout=900";
