...
{
    public partial class BlendingUC : UserControl
    {
        public BlendingUC()
        {
            InitializeComponent();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.DrawString("加水设定值:" + setJsl + "t/h", Font, Brushes.Black, new Rectangle(0, Height - 30, this.Width, 15), this.sf);
            graphics.DrawString("加水反馈值:" + readJsl + "t/h", Font, Brushes.Black, new Rectangle(0, Height-15, this.Width, 15), this.sf);
