...
namespace LY_SINTER.PAGE.Analysis
{
    public partial class tiekuangfenjichuxingneng : UserControl
    {
        ...
        public void table1GetDataDefinite(DateTime start, DateTime end)
        {
            ...
            table.Rows.Clear();
           string sql = "select BATCH_NUM,b.MAT_DESC,ORE_CLASS,a.PLACE_ORIGIN,a.UNIT_PRICE,C_TFE,C_FEO,C_SIO2,C_CAO,C_MGO,C_AL2O3,C_S,C_P,C_LOT,C_H2O,C_ASH,C_PBO,C_ZN," +
        ...
        {
            string sql = "select BATCH_NUM,b.MAT_DESC,ORE_CLASS,GRIT_8,GRIT_5_8,GRIT_3_5,GRIT_1_3,GRIT_05_1,GRIT__025_05," +
