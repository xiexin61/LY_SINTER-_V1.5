...
{
    public partial class Frm_Ripe_analysis_HEAP : Form
    {
        public vLog _vLog { get; set; }
        public static bool isopen = false;
        DBSQL _dBSQL = new DBSQL(ConstParameters.strCon);
        public Frm_Ripe_analysis_HEAP()
        {
            InitializeComponent();
            if (_vLog == null)//声明日志
                _vLog = new vLog(".\\log_Page\\Analysis\\Frm_Ripe_analysis_HEAP\\");
        ...
        public void Time_now()
        {
            try
            {
                string sql1 = "select top 1 RECORD_TIME from MC_NUMCAL_INTERFACE_6_HEAP order by RECORD_TIME desc";
