...
{
    public partial class Frm_Ripe_analysis_PAR : Form
    {
        ...
        public Frm_Ripe_analysis_PAR()
        {
            ...
            if (_vLog == null)
                _vLog = new vLog(".\\log_Page\\Analysis\\Frm_Ripe_analysis_PAR\\");
            DATE_NAME();
        ...
        {
            biaoming = "MC_NUMCAL_INTERFACE_6_PAR";
            biaoming1 = "MC_NUMCAL_INTERFACE_6_PAR_DESC";
            biaoming2 = "MC_NUMCAL_INTERFACE_6_PAR_CHANGE";
        }
        /// <summary>
        /// 开始时间-结束时间赋值
        /// </summary>
