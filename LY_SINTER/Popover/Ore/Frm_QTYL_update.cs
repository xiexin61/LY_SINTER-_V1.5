...
{
    public partial class Frm_QTYL_update : Form
    {
        DBSQL dBSQL = new DBSQL(ConstParameters.strCon);
        string BATCH_NUM = "", MAT_DESC = "";
        public static bool isopen = false;
        public Frm_QTYL_update(string num, string name)
        {
            InitializeComponent();
            BATCH_NUM = num;
            MAT_DESC = name;
        ...
        {
            while (d1.Rows.Count < 42)
            {
                d1.Rows.Add();
            }
            string sql = "select BATCH_NUM,b.MAT_DESC,PLACE_ORIGIN,a.UNIT_PRICE,C_TFE,C_FEO,C_SIO2,C_CAO,C_MGO,C_AL2O3,C_S,C_P,C_C,C_LOT,C_MN,C_R,C_H2O,C_ASH," +
                ...
                "from M_OTH_MATERIAL_ANALYSIS a, M_MATERIAL_COOD b where a.L2_CODE = b.L2_CODE and b.MAT_DESC = '" + name + "' and BATCH_NUM = " + num + "; ";
            ...
            d1.Rows[34].Cells["function"].Value = "+8 mm";
            d1.Rows[35].Cells["function"].Value = "5-8 mm";
            d1.Rows[36].Cells["function"].Value = "3-5 mm";
            d1.Rows[37].Cells["function"].Value = "1-3 mm";
            d1.Rows[38].Cells["function"].Value = "0-1 mm";
            d1.Rows[39].Cells["function"].Value = "平均粒度 mm";
            d1.Rows[40].Cells["function"].Value = ">3mm";
            d1.Rows[41].Cells["function"].Value = "<3mm";
        ...
        {
            string sql = "update M_OTH_MATERIAL_ANALYSIS set ";
